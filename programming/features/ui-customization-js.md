...
Manually add in generated `some/where/dce.ui.js`:
...
We have provided a sample [React with Customized Camera UI](https://github.com/Dynamsoft/barcode-reader-javascript-samples/tree/main/scenarios/customize-ui) for your reference.
